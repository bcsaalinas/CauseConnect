...
**Resources Used**
- [YouTube Tutorial 1](https://www.youtube.com/watch?v=9hnJsNIBq1g)
- [YouTube Tutorial 2](https://www.youtube.com/watch?v=3dh6hoGcyLQ)
...
- Add a submit button for the search bar
...
**Project / Module:** GSAP Redesign & Animation Implementation
...
**Use of Gen AI:**
Minimal usage – checked proper Express route syntax
...
**Use of Gen AI:**
Minimal usage – confirmed Axios syntax and EJS loops
...
**Use of Gen AI:**
Minimal usage – syntax checks for EJS and Bootstrap grid
...
**Use of Gen AI:**
Minimal usage – verified EJS include syntax
...
**Use of Gen AI:**
Minimal usage – confirmed Axios calls and EJS iteration
...
**Use of Gen AI:**
Minimal usage – syntax verification
...
**Project / Module:** Migration Review

**Decision:** Accepted Vite-based React migration plan.
...
### Alberto Cisneros
**Responsibility:** React Migration & Frontend Architecture
**Main Achievements:**
- Migrated entire application from Express/EJS to React SPA
- Implemented React Router for client-side navigation
- Integrated GSAP animations with React hooks (useEffect, useRef)
- Maintained glassmorphism design system in reusable components
- Created custom hooks for animations (useFadeIn, useScrollReveal)
- Implemented scroll storytelling and hero animations
- Ensured responsive design and reduced-motion accessibility
**Key Learnings:** React hooks, component lifecycle, GSAP with React, component architecture, performance optimization, CSS modules
**Main Challenges:**
- GSAP ScrollTrigger memory leaks on route changes → Fixed with proper cleanup functions
- Animations conflicting with React's virtual DOM → Used useRef for stable DOM references
- Component re-renders restarting animations → Implemented proper useEffect dependencies

### Isaac Zenteno
**Responsibility:** Authentication System, MongoDB Integration & Data Persistence
**Main Achievements:**
- Built RESTful API with Express for React consumption
- Designed MongoDB schemas (Users, NGOs, Favorites, Interactions)
- Implemented JWT-based authentication system (register, login)
- Made Login/Signup buttons fully functional Created data persistence across sessions (favorites, bookmarks, preferences)
- Integrated third-party NGO API for consulting organization information
**Key Learnings:** MongoDB & Mongoose

### Juan Francisco Luna
**Responsibility:** Volunteer Sessions, NGO Creation System & UX Enhancement
**Main Achievements:**
- Built comprehensive volunteer session management system
- Session booking interface with calendar view
- "My Volunteer Sessions" dashboard
- Session cancellation and feedback/rating system
- Session history with hours contributed tracking
- Implemented complete NGO creation system
- Multi-step form wizard (Basic Info, Contact, SDGs, Images, Documents)
- Image/document upload with validation
- Preview mode before submission
- "My NGOs" dashboard for user-created organizations
- Enhanced user dashboard with statistics and impact visualization
- Connected all features to backend APIs with proper validation
**Key Learnings:** Multi-step forms, file uploads, date/time handling, complex state management, form validation, CRUD operations, user experience design, optimistic UI updates
**Main Challenges:**
- Multi-step form losing data between steps → Implemented Context API and localStorage drafts
- Image upload preview failing on mobile → Used FileReader API with proper error handling
- Session double-booking → Coordinated with backend for capacity checking with database locks
- Timezone issues with session dates → Implemented proper UTC conversion
- Large image uploads failing → Added client-side compression and progress indicators

### Project Requirements Fulfilled:
- ✅ **Account Creation & Modification:** JWT authentication system with user profile editing, avatar upload, settings management
- ✅ **Third-Party Service Consultation:** Integration with external NGO data API with caching and rate limiting
- ✅ **CRUD Operations with Session Persistence:**
    - User favorites (add, view, remove NGOs)
    - Volunteer sessions (book, cancel, rate)
    - NGO creation (create, edit, delete user-created organizations)
    - User notes on NGOs (add, edit, delete)
    - All data persists across sessions using MongoDB
